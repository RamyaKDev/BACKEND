...
public class MovieServiceImpl implements IMovieService{
	...
	//giving cachename
	private final String CACHENAME="MOVIES";
	...
	@Override
	@CachePut(cacheNames = CACHENAME,key="#movieDto.id")
	public void updateMovie(MovieDto movieDto) {
		System.out.println("updating movie "+movieDto.getMovieId());
		Movie movie=mapper.map(movieDto,Movie.class);
		movieRepository.save(movie);
	...
	@Override
	@Cacheable(cacheNames = CACHENAME,key="#movieId")
	public MovieDto getByMovieId(int movieId) throws MovieNotFoundException {
		System.out.println("fetch from db "+movieId);
